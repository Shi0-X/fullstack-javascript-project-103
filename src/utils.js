...
const getIndentation = (depth, spacesCount = 4) => ' '.repeat(depth * spacesCount - 2); // Restar 2 para alinear los símbolos correctamente
...
const stylish = (diff) => formatNode(diff, 0) // Retorna el nodo formateado
;
